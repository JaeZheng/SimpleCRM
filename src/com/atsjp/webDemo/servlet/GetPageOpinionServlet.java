 ...
 * 处理分页获取opinion队列
 */
@WebServlet("/GetPageOpinionServlet")
public class GetPageOpinionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Opinion> tempCu = new LinkedList<Opinion>();
	private Page pageService = new Page();
	private UserService us = new UserService();

	public GetPageOpinionServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		// 进行查找company信息
		tempCu = us.getAllOpinion(currentPage, pageSize);
