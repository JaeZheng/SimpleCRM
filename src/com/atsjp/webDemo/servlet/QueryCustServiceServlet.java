...
/**
 * 
 * 处理分页查询获取custService队列
 */
@WebServlet("/QueryCustServiceServlet")
public class QueryCustServiceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<CustService> tempCu = new LinkedList<CustService>();
	private UserService us = new UserService();
    private Page pageService = new Page();

	public QueryCustServiceServlet() {
		super();
	}
...
//                System.out.println("index值:" + index);
        ...
        // 获取查询总个数
        pageService.queryCustServiceCount(index);
        // 维护当前页
...
//        System.out.println("当前页：" + Integer.toString(currentPage));
		// 进行查找custService信息
		tempCu = us.queryCustServiceList(index, currentPage, pageSize);
		...
		if (!tempCu.isEmpty()) {
			...
			request.getRequestDispatcher("./manager/queryCustService.jsp")
