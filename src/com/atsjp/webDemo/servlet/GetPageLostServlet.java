 ...
 * 处理分页获取lost队列
 */
@WebServlet("/GetPageLostServlet")
public class GetPageLostServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Lost> tempCu = new LinkedList<Lost>();
	private Page pageService = new Page();
	private UserService us = new UserService();

	public GetPageLostServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		// 进行查找company信息
		tempCu = us.getAllLost(currentPage, pageSize);
		...
		if (!tempCu.isEmpty()) {
			...
			request.getRequestDispatcher("./manager/getAllLost.jsp")
